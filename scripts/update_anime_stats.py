...
def build_svg(stats: Stats) -> str:
  ...
  <text x="470" y="168" fill="#1E293B" font-family="Segoe UI, Arial, sans-serif" font-size="30" font-weight="800">{stats.total_issues}</text>
  ...
  <text x="470" y="246" fill="#1E293B" font-family="Segoe UI, Arial, sans-serif" font-size="27" font-weight="800">{stats.contributed_repos}</text>
  ...
  <g transform="translate(670 78)">
    ...
    <text x="112" y="205" text-anchor="middle" fill="#0F172A" font-family="Segoe UI, Arial, sans-serif" font-size="32" font-weight="800">{stats.year_commits}</text>
